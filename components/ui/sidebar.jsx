      ...
      return (
         <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
            <SheetContent
               ...
               data-slot="sidebar"
               data-mobile="true"
               className="text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden bg-[hsl(228deg_13.51%_7.25%/80%)]"
               style={{
...
function SidebarContent({ className, ...props }) {
   return (
      <div
         ...
         className={cn(
            "no-scrollbar gap-0 flex min-h-0 flex-1 flex-col overflow-auto group-data-[collapsible=icon]:overflow-hidden pt-4",
            className,
         )}
         {...props}
      />
...
function SidebarGroupLabel({ className, render, ...props }) {
   return useRender({
      ...
      props: mergeProps(
         {
            className: cn(
               "text-accent ring-sidebar-ring rounded-md pt-4 px-2 text-sm font-medium transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 flex shrink-0 items-center outline-hidden [&>svg]:shrink-0",
               className,
            ),
         },
         props,
...
function SidebarMenuSub({ className, ...props }) {
   return (
      <ul
         ...
         className={cn(
            "border-sidebar-border mx-3.5 translate-x-px rtl:-translate-x-px border-s px-2.5 py-0.5 group-data-[collapsible=icon]:hidden flex min-w-0 flex-col",
            className,
         )}
         {...props}
      />
